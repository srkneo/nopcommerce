...
CREATE INDEX `IX_ProductVariant_ProductId` ON `ProductVariant` (`ProductId`, `Price`,`AvailableStartDateTimeUtc`,`AvailableEndDateTimeUtc`,`Published`,`Deleted`)
-- GO
...
CREATE INDEX `IX_OrderProductVariant_OrderId` ON `OrderProductVariant` (`OrderId` ASC)
-- GO

CREATE INDEX `IX_OrderNote_OrderId` ON `OrderNote` (`OrderId` ASC)
-- GO

CREATE INDEX `IX_TierPrice_ProductVariantId` ON `TierPrice` (`ProductVariantId` ASC)
-- GO
...
CREATE INDEX `IX_ProductVariant_DisplayOrder` ON `ProductVariant` (`DisplayOrder` ASC)
-- GO

CREATE INDEX `IX_ProductVariantAttributeValue_ProductVariantAttributeId` ON `ProductVariantAttributeValue` (`ProductVariantAttributeId` ASC)
-- GO

CREATE INDEX `IX_ProductVariant_ProductAttribute_Mapping_ProductVariantId` ON `ProductVariant_ProductAttribute_Mapping` (`ProductVariantId` ASC)
-- GO
...
CREATE INDEX `IX_ProductVariant_ProductId_2` ON `ProductVariant` (`ProductId` ASC)
-- GO
