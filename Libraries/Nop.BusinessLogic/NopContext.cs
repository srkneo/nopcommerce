            ...
            set
            {
                ...
                if (customer != null)
                {
                    customer = CustomerManager.UpdateCustomer(customer.CustomerID, customer.CustomerGUID,
                        ...
                        customer.GiftCardCouponCodes, customer.LanguageID, value.CurrencyID, customer.TaxDisplayType,
            ...
            set
            {
                ...
                if (customer != null)
                {
                    customer = CustomerManager.UpdateCustomer(customer.CustomerID, customer.CustomerGUID,
                        ...
                        customer.BillingAddressID, customer.ShippingAddressID,
                        customer.LastPaymentMethodID, customer.LastAppliedCouponCode,
                        customer.GiftCardCouponCodes, value.LanguageID, customer.CurrencyID, customer.TaxDisplayType,
                        customer.IsTaxExempt, customer.IsAdmin, customer.IsGuest,
                        customer.IsForumModerator, customer.TotalForumPosts,
            ...
            set
            {
                ...
                if (customer != null)
                {
                    customer = CustomerManager.UpdateCustomer(customer.CustomerID, customer.CustomerGUID,
                        ...
                        customer.BillingAddressID, customer.ShippingAddressID,
                        customer.LastPaymentMethodID, customer.LastAppliedCouponCode,
                        customer.GiftCardCouponCodes, customer.LanguageID, customer.CurrencyID, value,
                        customer.IsTaxExempt, customer.IsAdmin, customer.IsGuest,
                        customer.IsForumModerator, customer.TotalForumPosts,
